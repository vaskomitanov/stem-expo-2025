...
simon_says = [
    ...
    { "cmd": "left leg up", "check": lambda p: pose.left_leg_up(p) and not pose.right_leg_up(p)},
    { "cmd": "right leg up", "check": lambda p: pose.right_leg_up(p) and not pose.left_leg_up(p)},
